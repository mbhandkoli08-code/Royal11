...
DEFAULTS = {
    ...
    "tiers": [
        {"key": "bronze", "label": "Bronze", "min_xp": 0, "rakeback_pct": 0},
        {"key": "silver", "label": "Silver", "min_xp": 5_000, "rakeback_pct": 2},
        {"key": "gold", "label": "Gold", "min_xp": 25_000, "rakeback_pct": 5},
        {"key": "platinum", "label": "Platinum", "min_xp": 100_000, "rakeback_pct": 8},
        {"key": "royal", "label": "Royal", "min_xp": 500_000, "rakeback_pct": 12},
    ],
}
...
async def set_config(patch: dict) -> dict:
    allowed = {k: patch[k] for k in ("coins_per_xp", "practice_multiplier", "tiers") if k in patch}
