...
## Backlog / Remaining
- P1: Admin Console — Phase 2 (Figma frames not yet built): Users/Players management, Rewards & Game admin, Reports, Notifications, Support, Settings. NOTE: Deposit Mgmt / Withdrawal Mgmt / Bank Accounts are on HOLD pending internal decision (non-withdrawable virtual-coin model) — do NOT build.
